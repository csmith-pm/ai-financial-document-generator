 ...
 *
 * Municipal budgets come in wildly different Excel formats, so we:
 * 1. Use xlsx (SheetJS) to convert all sheets to JSON/text
 * 2. Send the structured data to AI for interpretation
 * 3. Map AI's output to our BudgetBookData interfaces
 */
