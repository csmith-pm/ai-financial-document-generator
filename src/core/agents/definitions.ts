/**
 * Formal agent definitions for the budget book generation team.
 *
 * Each agent has a name, role, base system prompt, skill configuration,
 * and model parameters. Prompts are assembled at runtime by the
 * promptBuilder, which injects accumulated skills on top of the base.
 */
