/**
 * Global Skill Seeds — starter skills that ship with the product.
 *
 * These provide a baseline of knowledge for new tenants before
 * their agent team has accumulated any tenant-specific learnings.
 ...
 */
export async function seedGlobalSkills(db: DrizzleInstance): Promise<number> {
